...
export default function ReviewSection() {
    return <div className="w-full bg-white h-1/2 rounded-lg p-4">
        {/* TODO: make it dynamic */}
        <p className="text-xl font-medium">Reviews</p>
        <ScrollArea className="h-[95%]">
            <div className="mt-3">
                <div className="flex gap-10">
                    <div className="w-1/2 bg-gray-300 rounded-lg flex flex-col items-center justify-center p-4">
            ...
            <div className="mt-5 h-1/2 overflow-hidden">
                <Review name="tarun kushwaha" rating={1} date="2 days ago" content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing nec, ultricies sed, dolor. Cras elementum ultrices diam. Maecenas ligula massa, varius a, semper congue, euismod non, mi." />
                <Review name="tarun kushwaha" rating={1} date="2 days ago" content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing nec, ultricies sed, dolor. Cras elementum ultrices diam. Maecenas ligula massa, varius a, semper congue, euismod non, mi." />
