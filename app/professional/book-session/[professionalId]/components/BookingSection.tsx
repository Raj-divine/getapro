...
export default function BookingSection() {
    ...
    return <div className="flex-1 bg-white rounded-lg p-4 flex flex-col justify-between">
        <div>
            <div>
                <h5 className="font-heading font-semibold text-xl">Book a consultation</h5>
                <p className="text-gray-500 text-sm">Select a date and time for your session</p>
            </div>
            <div className="flex flex-col item-center mt-5 w-full">
                ...
                <div className="flex justify-center">
                    <Calendar
                        ...
                        disabled={{ before: new Date(), after: new Date(Date.now() + 1000 * 60 * 60 * 24 * 30) }}
                    />
                </div>
                <Separator />
            </div>
                    ...
                    <div className="mt-5">
                        <div className="font-heading  flex flex-wrap">
                            <ScrollArea className="h-40">
                                <MultiSelectButtons options={options} selected={selectedTime} onChange={setSelectedTime} />
                            </ScrollArea>
