...
export default function BookingSection() {
    ...
    return (
        <>
            <div className='flex-1 h-screen bg-white rounded-lg p-4 flex flex-col justify-between'>
                <ScrollArea className='max-md:h-[40rem]'>
                    <div>
                    ...
                    <div className='mt-5 flex flex-col justify-between'>
                        <div>
                            ...
                            <div className='mt-5'>
                                ...
                                <Separator className='mt-3 xl:mt-10' />
                            </div>
                        </div>
                    </div>
                </ScrollArea>
