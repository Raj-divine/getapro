    ...
    return <Sidebar>
        <SidebarHeader className="h-16 border-b">
            <div className='relative w-1/4 h-full'>
                <Link href='/'>
                    <Image alt='Logo' objectFit="" fill priority src='/assets/svgs/logo.svg' />
                </Link>
            </div>
        </SidebarHeader>
        <SidebarContent>
            <SidebarGroup>
                ...
                <SidebarGroupContent>
                    <SidebarMenu>
                        <SidebarMenuItem>
                            <SidebarMenuButton onClick={() => setSelectedCategory(null)} isActive={selectedCategory === null}>
                                <Users />
        ...
        <SidebarFooter className="border border-t">
            <Button className="font-medium flex justify-center items-center w-full" variant="outline">
