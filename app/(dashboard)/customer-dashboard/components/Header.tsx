...
export default function Header() {
    return <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4 bg-white w-auto z-50">
                ...
                <Popover>
                    <PopoverTrigger asChild>
                        <button className="hover:bg-gray-100 text-primary p-2 rounded-lg transition-colors relative">
                            ...
                            <div className="bg-red-500 absolute top-1 right-1 h-2 w-2 rounded-full" aria-label="notifications" />
                        </button>
                    </PopoverTrigger>
